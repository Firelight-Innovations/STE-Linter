...
- [ ] If this adds a rule ID: it's covered by the corpus coverage check (`run_corpus_tests.py` fails loudly if a fixed rule ID in `lint/rule_ids.py` is never exercised)

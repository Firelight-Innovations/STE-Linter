...
| You have | Go to |
| --- | --- |
| A rule that fired on text that is correct | [False positive](https://github.com/Firelight-Innovations/STE100-Linter/issues/new?template=false_positive.yml) |
| A crash, a wrong exit code, or bad file discovery | [Bug report](https://github.com/Firelight-Innovations/STE100-Linter/issues/new?template=bug_report.yml) |
| A word, phrase, or check the linter does not cover yet | [New rule / word-list addition](https://github.com/Firelight-Innovations/STE100-Linter/issues/new?template=rule_request.yml) |
| A usage question, or an open-ended proposal | [Discussions](https://github.com/Firelight-Innovations/STE100-Linter/discussions) |
...
- [Wiki](https://github.com/Firelight-Innovations/STE100-Linter/wiki) -- orientation, CLI reference, configuration, integrations.
